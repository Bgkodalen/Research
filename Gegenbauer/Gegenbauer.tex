...
Therefore $\phi$ preserves the matrix multiplication structure of $\mathbb{A}$ while $\phi^*$ preserves the entrywise structure of $\mathbb{A}$.
...
Therefore, $H_kH_k^T$ is positive semi-definite. If we now assume $X$ consists of the columns of $U$ \newpage
