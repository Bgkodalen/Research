...
\date[September 26, 2018]{PhD Thesis Proposal\\September 26, 2018}
...
Determined by three parameters, $k>r>s=-n^2$. For fixed $s=-49$:
\only<1>{\begin{figure}
		\includegraphics[width=2.5in,height=2.5in]{onlybound7py}
\end{figure}}
\only<2>{\begin{figure}
		\includegraphics[width=2.5in,height=2.5in]{bounds7py}
\end{figure}}
\only<3>{\begin{figure}
		\includegraphics[width=2.5in,height=2.22in]{geg7}
\end{figure}\vspace{.7in}}\pause\pause\vspace{-.129in}\begin{center}
304 (of 1274) sets ruled out.
\end{center}
\end{frame}
