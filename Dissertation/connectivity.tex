...
We are now ready to present the proof of our main theorem. We continue with the notation established previously in this chapter. Recall that, for $a\in X$,  $\Gamma_a := \Gamma \setminus a^\bot$ is the subgraph of $\Gamma = (X,R_i)$ 
