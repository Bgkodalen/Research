...
\[\begin{aligned}
v &= q^{m+1}(q^m+\dots+q+2) \qquad k= q^m(q^m+\dots+q+1) \qquad \lambda = q^m(q^{m-1}+\dots+q+1)\\ s &= q^m\qquad
...
\[\begin{aligned}
v&=4q^{2d}\left(\frac{q^{2d}-1}{q^2-1}\right)\qquad k=q^{2d-1}\left(1+2\left(\frac{q^{2d}-1}{q+1}\right)\right)\qquad\lambda = q^{2d-1}(q-1)\left(\frac{q^{2d-1}+1}{q+1}\right)\\ s&=q^{2d-1}\qquad
...
\[\begin{aligned}
v&=2^{2d+3}\left(\frac{q^{2m}-1}{q+1}\right)\qquad k= 2^{2d+1}q^{2m-1}\qquad \lambda = 2^{2d-1}(q+1)q^{2m-2}\qquad s=2^{2d+1}q^{m-1}\\ q&=\frac{1}{3}\left(2^{2d+3}+1\right)\qquad
...
\[\begin{aligned}
v&=2^{2d+3}\left(\frac{q^{2m}-1}{3q-3}\right)\qquad k = 2^{2d+1}q^{2m-1} \qquad \lambda = 3\left(2^{2d-1}\right)(q-1)q^{2m-2}\qquad s = 2^{2d+1}q^{m-1}\\ q&=2^{2d+3}-3\qquad
