...
\begin{proof}
	...
	\end{aligned}\]
	Recall that $m = v(1+k\beta^2)^{-1}$ and therefore $v-m(1+\beta^2k)=0$. Thus we have both $v-m(1+\beta^2r)>0$ and $v-m(1+\beta^2s)>0$ as long as $r<k$ (i.e.\ $\Gamma$ is connected), forcing all three of the above Krein parameters to be nonzero. Thus $\BMA$ is $Q$-polynomial if and only if $q^{4}_{11}=0$. Calculating this similarly, we find
