...
\begin{restatable*}{thm}{schAS}\label{schoen-as}
	...
	\end{equation}
	The eigenvalues of $Q_\ell^{m_i}\circ\left(\frac{\vert X\vert}{m_i}E_i\right)$ are $\theta_{\ell 0},\dots,\theta_{\ell d}$ where $\theta_{\ell j}$ is nonzero only if $E_j$ is contained in the Schur subalgebra generated by $E_i$.
\end{restatable*}
