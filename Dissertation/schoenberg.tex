...
Therefore, as shown in the above cases, as long as $(1+\mu_k)^2\lambda^2-4\mu_k\neq0$, then every eigenvalue $\phi\neq 1$ of $B_k$ is bounded above by the second largest eigenvalue of $\frac{1}{m_i}L_i^*$ in absolute value. Further, the eigenvalue $1$ has multiplicity $1$ with eigenvector $\ones$. Now recall that the eigenvectors of $\frac{1}{m_i}L_i^*$ are the columns of $P$, the first eigenmatrix of our association scheme. Further, we have the property that for any $1\leq i\leq d$, the $i^\text{th}$ column of $P$ is orthogonal to the vector $\vec{m} = [1,m_1,\dots,m_d]$. Define 
\[\Delta^{\frac{1}{2}} = \left[\begin{array}{cccc}
1 & 0 & \dots & 0\\
0 & \sqrt{m_1}  & \dots & 0\\
...
\end{array}\right] \]
Then we have
\[\left(\Delta^\frac{1}{2}y_k\right) = \Delta^\frac{1}{2}B_k\left(\Delta^\frac{1}{2}\right)^{-1}\left(\Delta^\frac{1}{2}y_{k-1}\right)\]
